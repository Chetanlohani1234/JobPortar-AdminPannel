...
const EditEducation = () => {
    ...
    useEffect(() => {
        const getSingleQualification = async () => {
          try {
            const requestBody = {
            ...
            const response = await axios.post(`https://jobpartal-backend.onrender.comapi/Qualification/${Id}`, requestBody, {
              headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const res = await fetch(`https://jobpartal-backend.onrender.comapi/Update/Qualification/${Id}`, { // Corrected URL
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="d-flex w-100 justify-content-between align-items-center mb-4">
                    <h4 className="mb-0" style={{marginLeft:"50px"}}>Update Education</h4>
