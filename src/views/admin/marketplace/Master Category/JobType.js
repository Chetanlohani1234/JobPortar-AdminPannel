...
const JobType = () => {
    ...
    const deleteJobType = async (Id, name) => {
        setLoading(true);
        setError(null);
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12">
                <h4 className="f-700 mb-4">All JobType</h4>
                {message && (
                ...
                <div className="table-header d-flex align-items-center">
                    ...
                    <form class="d-flex align-items-center ms-auto">
                      <Link to={"/admin/AddJobType"} className="btn btn-primary">Add JobType</Link>
                            ...
                            <tr key={job.Id}>
                                ...
                                <td width="150"><span className="d-flex justify-content-end">
                                    {/* <Link to={"/edit-ticket/" + job._id} className="mx-2"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <Link to={"/admin/EditJobType/" + job.Id} className="mx-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        type="button"
        className="mx-2"
        onClick={() => deleteJobType(job.Id,job.Name)}
